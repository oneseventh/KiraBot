...
class LogCommands(commands.Cog):
    ...
    # @nextcord.slash_command(name="set_textchannel", description="로그를 저장할 채널을 선택 합니다.", guild_ids=guild_id)
